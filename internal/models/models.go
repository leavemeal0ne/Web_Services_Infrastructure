...
type Worker struct {
	...
	FullName   string `json:"full_name" db:"full_name" validate:"required,min=6,max=100,alpha"`
...
type Position struct {
	Id          int    `json:"id" db:"id"`
	Title       string `json:"title" db:"title" validate:"required,min=6,max=100,alpha"`
